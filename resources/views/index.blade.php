    ...
    <div class="bg-cover bg-no-repeat bg-center py-36" style="background-image: url('assets/images/banner-bg.jpg');">
        <div class="container">
            <h1 class="text-6xl text-gray-800 font-medium mb-4">
                Découvrez notre collection <br> de produits de beauté
            </h1>
            <p>Explorez nos produits haut de gamme pour sublimer votre beauté. <br>
                Qualité exceptionnelle, soins naturels et résultats visibles.
            </p>
            <div class="mt-12">
                <a href="/shop"
                    class="bg-primary border border-primary text-white px-8 py-3 font-medium
                rounded-md hover:bg-transparent hover:text-primary">Découvrir
                    Maintenant</a>
            </div>
        </div>
    </div>
    ...
    <div class="container py-16">
        <div class="w-10/12 grid grid-cols-1 md:grid-cols-3 gap-6 mx-auto justify-center">
            <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                ...
                <div>
                    <h4 class="font-medium capitalize text-lg">Livraison a domicile</h4>
